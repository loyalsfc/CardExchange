    ...
    return(
        <section className="px-2 sm:px-0 py-3">
            <div className="container mx-auto">
                <h2 data-aos="zoom-in-up" className="text-3xl sm:text-4xl text-center font-bold text-white">Why You Should Trade Your Gift Card With Us</h2>
                <p data-aos="zoom-in" className="text-center text-white text-lg my-6">We know there are quite a number of scammers out there, but here are the few reasons why you should trust us with your card</p>
...
function Items({icon, title, description, color}){
    return(
        <div data-aos="flip-up" className={`text-center text-white p-4 ${color} rounded-lg hover:-mt-4`}>
