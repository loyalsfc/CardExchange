                ...
                <div className="container mx-auto bg-[#1A1919] py-8">
                    <div className="flex flex-col lg:flex-row" >
                        ...
                        <div className='text-white basis-1/2 lg:pr-20'>
                            ...
                            <p data-aos="fade-up" className='section-subtitle'>We buy all types of giftcards. If you are looking for a reliable place to trade your cards 24/7, we are here for you.</p>
